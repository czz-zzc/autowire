...
// Revision: $Id: //dwh/DW_ocb/DW_axi_x2x/amba_dev/src/DW_axi_x2x.v#8 $ 
--
-- File     : DW_axi_x2x.v
...
module DW_axi_x2x (
  ...
  // LJ:  If the X2X_MP_AW is greater than X2X_SP_AW then the MSB bits(X2X_MP_AW-X2X_SP_AW) are unused.
  // leda NTL_CON37 off
  ...
  // leda NTL_CON13C off
  // LMD: non driving port.
  // LJ: If Slave Port ID Width is > Master Port IDW, the MSbits of this signal will be unused.
  // leda NTL_CON37 off
  // LMD: Signal/Net must read from the input port in module.
  // LJ: If Slave Port ID Width is > Master Port IDW, the MSbits of this signal will be unused.
