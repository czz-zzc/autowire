...
// 
// Release version :  1.05a
// File Version     :        $Revision: #23 $ 
// Revision: $Id: //dwh/DW_ocb/DW_axi_x2x/amba_dev/src/DW_axi_x2x_cc_constants.v#23 $ 
--
...
// Values:       4 5 6 7 8
// 
// X2X master port burst length signal width.
`define X2X_MP_BLW 4
...
//  * Must be greater than or equal to Master Port ID Width (X2X_MP_IDW)
`define X2X_SP_IDW 4
...
// Enabled:      0
// 
// X2X slave port burst length signal width. 
//  
// This parameter value is controlled by X2X_MP_BLW.
`define X2X_SP_BLW 4
